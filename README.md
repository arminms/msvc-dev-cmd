<a href="https://github.com/arminms/msvc-dev-cmd"><img alt="GitHub Actions status" src="https://github.com/arminms/msvc-dev-cmd/workflows/msvc-dev-cmd/badge.svg"></a>
...
You can invoke `arminms/msvc-dev-cmd` multiple times during your jobs with different inputs
